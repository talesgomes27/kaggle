...
site <- "http://dados.agricultura.gov.br/dataset/420c0514-92da-4888-be85-290a0785e8a9/resource/f192c841-b95f-4e6e-9a32-70db6838e6f1/download/rfincendiosflorestaisfocoscalorestados1998-2017.csv"


fire_data_base <- data.table::fread(site,
                           quote="\"", sep = "\t", encoding = 'Latin-1', check.names = TRUE)
